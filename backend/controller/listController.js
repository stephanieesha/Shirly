...
const getUserShoppingList = asyncHandler(async(req, res) => {
   ...
   const Everyday = await List.find({ id: req.user_id , "frequency": 'Everyday', $or: [{"boughtAt.updatedAt" : { $lte : new Date(oneDayBack)}},{"updatedAt" :{$lte: new Date(oneDayBack)}}]})
   const Every2days = await List.find({ id: req.user_id , "frequency": 'Every 2 days', $or: [{"boughtAt.updatedAt" : { $lte : new Date(twoDaysBack)}},{"updatedAt" :{$lte: new Date(twoDaysBack)}}]})
   const Every3days = await List.find({ id: req.user_id , "frequency": 'Every 3 days', $or: [{"boughtAt.updatedAt" : { $lte : new Date(threeDaysBack)}},{"updatedAt" :{$lte: new Date(threeDaysBack)}}]})
   const Weekly = await List.find({ id: req.user_id , "frequency": 'Weekly', $or: [{"boughtAt.updatedAt" : { $lte : new Date(oneWeekBack)}},{"updatedAt" :{$lte: new Date(oneWeekBack)}}]})
   const Every2weeks = await List.find({ id: req.user_id , "frequency": 'Every 2 weeks', $or: [{"boughtAt.updatedAt" : { $lte : new Date(twoWeeksBack)}},{"updatedAt" :{$lte: new Date(twoWeeksBack)}}]})
   const Monthly = await List.find({ id: req.user_id , "frequency": 'Monthly', $or: [{"boughtAt.updatedAt" : { $lte : new Date(oneMonthBack)}},{"updatedAt" :{$lte: new Date(oneMonthBack)}}]})
   const Every2months = await List.find({ id: req.user_id , "frequency": 'Every 2 months', $or: [{"boughtAt.updatedAt" : { $lte : new Date(twoMonthsback)}},{"updatedAt" :{$lte: new Date(twoMonthsback)}}]})
   const Every3months = await List.find({ id: req.user_id , "frequency": 'Every 3 months', $or: [{"boughtAt.updatedAt" : { $lte : new Date(threeMonthsback)}},{"updatedAt" :{$lte: new Date(threeMonthsback)}}]})
   const Every6months = await List.find({ id: req.user_id , "frequency": 'Every 6 months', $or: [{"boughtAt.updatedAt" : { $lte : new Date(sixMonthsback)}},{"updatedAt" :{$lte: new Date(sixMonthsback)}}]})
   const Yearly = await List.find({ id: req.user_id , "frequency": 'Yearly', $or: [{"boughtAt.updatedAt" : { $lte : new Date(oneYearBack)}},{"updatedAt" :{$lte: new Date(oneYearBack)}}]})
  ...
  await List.updateMany({ id: req.user_id , "frequency": 'Everyday', "updatedAt" : { $lte : new Date(oneDayBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 2 days', "updatedAt" : { $lte : new Date(twoDaysBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 3 days', "updatedAt" : { $lte : new Date(threeDaysBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Weekly', "updatedAt" : { $lte : new Date(oneWeekBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 2 weeks', "updatedAt" : { $lte : new Date(twoWeeksBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Monthly', "updatedAt" : { $lte : new Date(oneMonthBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 2 months', "updatedAt" : { $lte : new Date(twoMonthsback) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 3 months', "updatedAt" : { $lte : new Date(threeMonthsback) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 6 months', "updatedAt" : { $lte : new Date(sixMonthsback) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Yearly', "updatedAt" : { $lte : new Date(oneYearBack) }}, {"$set":{"shoppingInProgress": true}})
...
const getShoppingHistories = asyncHandler(async(req, res) => {
    const shoppingHistories = await ShoppingHistory.find({ id: req.user_id })
