...
const getUserShoppingList = asyncHandler(async(req, res) => {
   ...
   const Everyday = await List.find({ id: req.user_id , "frequency": 'Everyday', $or: [{"boughtAt.updatedAt" : { $gte : new Date(oneDayBack)}},{"updatedAt" :{$gte: new Date(oneDayBack)}}]})
   const Every2days = await List.find({ id: req.user_id , "frequency": 'Every 2 days', $or: [{"boughtAt.updatedAt" : { $gte : new Date(twoDaysBack)}},{"updatedAt" :{$gte: new Date(twoDaysBack)}}]})
   const Every3days = await List.find({ id: req.user_id , "frequency": 'Every 3 days', $or: [{"boughtAt.updatedAt" : { $gte : new Date(threeDaysBack)}},{"updatedAt" :{$gte: new Date(threeDaysBack)}}]})
   const Weekly = await List.find({ id: req.user_id , "frequency": 'Weekly', $or: [{"boughtAt.updatedAt" : { $gte : new Date(oneWeekBack)}},{"updatedAt" :{$gte: new Date(oneWeekBack)}}]})
   const Every2weeks = await List.find({ id: req.user_id , "frequency": 'Every 2 weeks', $or: [{"boughtAt.updatedAt" : { $gte : new Date(twoWeeksBack)}},{"updatedAt" :{$gte: new Date(twoWeeksBack)}}]})
   const Monthly = await List.find({ id: req.user_id , "frequency": 'Monthly', $or: [{"boughtAt.updatedAt" : { $gte : new Date(oneMonthBack)}},{"updatedAt" :{$gte: new Date(oneMonthBack)}}]})
   const Every2months = await List.find({ id: req.user_id , "frequency": 'Every 2 months', $or: [{"boughtAt.updatedAt" : { $gte : new Date(twoMonthsback)}},{"updatedAt" :{$gte: new Date(twoMonthsback)}}]})
   const Every3months = await List.find({ id: req.user_id , "frequency": 'Every 3 months', $or: [{"boughtAt.updatedAt" : { $gte : new Date(threeMonthsback)}},{"updatedAt" :{$gte: new Date(threeMonthsback)}}]})
   const Every6months = await List.find({ id: req.user_id , "frequency": 'Every 6 months', $or: [{"boughtAt.updatedAt" : { $gte : new Date(sixMonthsback)}},{"updatedAt" :{$gte: new Date(sixMonthsback)}}]})
   const Yearly = await List.find({ id: req.user_id , "frequency": 'Yearly', $or: [{"boughtAt.updatedAt" : { $gte : new Date(oneYearBack)}},{"updatedAt" :{$gte: new Date(oneYearBack)}}]})
  ...
  await List.updateMany({ id: req.user_id , "frequency": 'Everyday', "updatedAt" : { $gte : new Date(oneDayBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 2 days', "updatedAt" : { $gte : new Date(twoDaysBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 3 days', "updatedAt" : { $gte : new Date(threeDaysBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Weekly', "updatedAt" : { $gte : new Date(oneWeekBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 2 weeks', "updatedAt" : { $gte : new Date(twoWeeksBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Monthly', "updatedAt" : { $gte : new Date(oneMonthBack) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 2 months', "updatedAt" : { $gte : new Date(twoMonthsback) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 3 months', "updatedAt" : { $gte : new Date(threeMonthsback) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Every 6 months', "updatedAt" : { $gte : new Date(sixMonthsback) }}, {"$set":{"shoppingInProgress": true}})
  await List.updateMany({ id: req.user_id , "frequency": 'Yearly', "updatedAt" : { $gte : new Date(oneYearBack) }}, {"$set":{"shoppingInProgress": true}})
